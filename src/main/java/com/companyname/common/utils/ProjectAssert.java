...
import com.companyname.common.exception.ProjectExceptionUtils;
...
* @date : 2021/9/14
*/
public final class ProjectAssert {
    /**
     * 断言这个 boolean 为 true
     * <p>为 false 则抛出异常</p>
     *
    ...
    public static void isTrue(boolean expression, String message, Object... params) {
        if (!expression) {
            throw ProjectExceptionUtils.mpe(message, params);
        }
    }
    ...
    public static void notEmpty(String value, String message, Object... params) {
        isTrue(!ObjectUtils.isEmpty(value), message, params);
    }
    ...
    public static void notEmpty(Object[] array, String message, Object... params) {
        isTrue(!CollectionUtils.isEmpty(Arrays.asList(array)), message, params);
    }
}
